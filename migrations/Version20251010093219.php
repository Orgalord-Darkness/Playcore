 ...
 */
final class Version20251010093219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_video_game (category_id INT NOT NULL, video_game_id INT NOT NULL, INDEX IDX_2A23C2E12469DE2 (category_id), INDEX IDX_2A23C2E16230A8 (video_game_id), PRIMARY KEY(category_id, video_game_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
